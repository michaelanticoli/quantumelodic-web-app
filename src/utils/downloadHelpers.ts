...
export async function downloadPdfReport(
  ...
  pdf.text('Generated by MoonTuner · quantumelodic.lovable.app', W / 2, y, { align: 'center' });

  pdf.save(`${reading.birthData.name.replace(/\s+/g, '-').toLowerCase()}-moontuner-report.pdf`);
}
